...
if __name__ == "__main__":
    ...
    #   读取数据集对应的txt
    # ---------------------------#
    with open(os.path.join("E:/machine-vision/cow_face_infrared/v9/ImageSets/Segmentation/train.txt"), "r") as f:
        train_lines = f.readlines()
    with open(os.path.join("E:/machine-vision/cow_face_infrared/v9/ImageSets/Segmentation/val.txt"), "r") as f:
